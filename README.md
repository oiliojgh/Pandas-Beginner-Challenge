...
Link GG Doc Challenge: https://docs.google.com/document/d/1kd4iXiXSdD_alCAKPncdf-oP9Zb-KAYgW9l5J265_u0/edit?tab=t.8xn3v27c3tfw

Pandas Beginner Project
Student Performance Analyzer
Project Overview

Your school has collected data about students' academic performance and study habits. Your task is to use Pandas to create, read, select, filter, modify, and analyze the dataset.
...
Convert the provided student_data dictionary into a Pandas DataFrame called students.
...
Read students.csv and store the resulting DataFrame in a variable called:
...
Select the club column using dot notation instead of square brackets.
...
Using only .iloc, select the first 5 students and the following columns:
...
Your solution should work without knowing how many rows are in the DataFrame.

Part 5 — Filtering with loc
Task 11 — Filter by Class

Select all students who are in class:
...
Use one Pandas command to generate a statistical summary of all numerical columns in the DataFrame.
...
Which high-performing students may be studying a lot while sleeping relatively little?
